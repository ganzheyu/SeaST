# 参数读取	设置 args	main.py
# 判断模式	args.mode == 'training' → ✅ pretrain	main.py
# 加载数据	data_load_main()	DataLoader.py
# 构建模型	UniST_model(args)	model.py
# 启动训练	TrainLoop(...).run_loop()	train.py
